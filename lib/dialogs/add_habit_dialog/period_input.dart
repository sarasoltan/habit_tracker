      ...
      children: [
        MiniDayButton(
          ...
          onValueChange: (newValue) =>
              controller.changePeriodValue(0, newValue),
        ),
        MiniDayButton(
          text: "T",
          initialChecked: controller.period[1],
          onValueChange: (newValue) =>
              controller.changePeriodValue(1, newValue),
        ),
        MiniDayButton(
          text: "W",
          initialChecked: controller.period[2],
          onValueChange: (newValue) =>
              controller.changePeriodValue(2, newValue),
        ),
        MiniDayButton(
          text: "T",
          initialChecked: controller.period[3],
          onValueChange: (newValue) =>
              controller.changePeriodValue(3, newValue),
        ),
        MiniDayButton(
          text: "F",
          initialChecked: controller.period[4],
          onValueChange: (newValue) =>
              controller.changePeriodValue(4, newValue),
        ),
        MiniDayButton(
          text: "S",
          initialChecked: controller.period[5],
          onValueChange: (newValue) =>
              controller.changePeriodValue(5, newValue),
        ),
        MiniDayButton(
          text: "S",
          initialChecked: controller.period[6],
          onValueChange: (newValue) =>
              controller.changePeriodValue(6, newValue),
        )
      ],
    );
  }
