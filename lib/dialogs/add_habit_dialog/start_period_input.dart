              ...
              Column(
                children: [
                  Box(
                      ...
                      text: "None",
                      onTap: () =>
                          controller.changeStartPeriod(StartPeriod.none)),
                  const Divider(color: Colors.transparent, height: 10),
                  Box(
                      selected: snapshot.data == StartPeriod.today,
                      text: "Today",
                      onTap: () =>
                          controller.changeStartPeriod(StartPeriod.today)),
                ],
              ),
              Column(
                children: [
                  Box(
                    ...
                    text: "This Month",
                    onTap: () =>
                        controller.changeStartPeriod(StartPeriod.thisMonth),
                  ),
                  const Divider(color: Colors.transparent, height: 10),
                  Box(
                    ...
                    text: "This Year",
                    onTap: () =>
                        controller.changeStartPeriod(StartPeriod.thisYear),
                  ),
                ],
              ),
            ],
...
class Box extends StatelessWidget {
  ...
  Box({required this.selected, required this.onTap, required this.text});
