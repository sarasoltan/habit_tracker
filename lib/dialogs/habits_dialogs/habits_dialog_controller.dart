...
import 'package:project2/dialogs/confirmation_dialog/confirmation_dialog.dart';
import 'package:project2/dialogs/habit_details_dialog/habit_details_dialog.dart';
...
class HabitsDialogController {
  ...
  String getDaysString(Habit habit) {
    ...
    } else if (habit.period.length == 2 &&
        habit.period.reduce((a, b) => a + b) == 13) {
      return "Weekend";
    } else if (habit.period.length == 5 &&
        habit.period.reduce((a, b) => a + b) == 15) {
      return "Work week";
    }
  ...
  void showDeleteHabitConfirmation(
      BuildContext context, int id, SlidableController slidableController) {
