...
import 'package:project2/themes/purple_green.dart';
import 'package:project2/themes/orange_blue.dart';
import 'package:project2/themes/yellow_blue.dart';
...
List<Color> getColors(ThemeColors color) {
  switch (color) {
    case ThemeColors.yellowBlue:
      return [
        YELLOW_BLUE_THEME.primary,
        YELLOW_BLUE_THEME.accent,
        YELLOW_BLUE_THEME.hightlight
      ];
    case ThemeColors.purpleGreen:
      return [
        PURPLE_GREEN_THEME.primary,
        PURPLE_GREEN_THEME.accent,
        PURPLE_GREEN_THEME.hightlight
      ];
    case ThemeColors.orangeBlue:
      return [
        ORANGE_BLUE_THEME.primary,
        ORANGE_BLUE_THEME.accent,
        ORANGE_BLUE_THEME.hightlight
      ];
  }
}
...
final lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      headline1: TextStyle(color: WHITE, fontSize: 28),
      headline2:
          TextStyle(color: BLACK, fontSize: 22, fontWeight: FontWeight.bold),
      headline3: TextStyle(color: BLACK, fontSize: 20),
      headline4: TextStyle(color: WHITE, fontSize: 18),
      bodyText2: TextStyle(color: BLACK, fontSize: 18),
      subtitle1: TextStyle(color: BLACK, fontSize: 12),
      subtitle2: TextStyle(color: BLACK, fontSize: 16),
      button: TextStyle(fontSize: 18, decoration: TextDecoration.underline),
    ),
...
final darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      headline3: TextStyle(color: WHITE, fontSize: 20),
      headline4: TextStyle(color: WHITE, fontSize: 18),
      bodyText2: TextStyle(color: WHITE, fontSize: 18),
      subtitle1: TextStyle(color: WHITE, fontSize: 12),
      subtitle2: TextStyle(color: WHITE, fontSize: 16),
      button: TextStyle(fontSize: 18, decoration: TextDecoration.underline),
    ),
    iconTheme: const IconThemeData(color: WHITE, size: 24));
