    ...
    return Container(
      ...
      child: StreamBuilder<int>(
          ...
          builder: (ctx, snapshot) {
            final selectedDay = DateTime(controller.selectedMonth.value.year,
                controller.selectedMonth.value.month, snapshot.data! + 1);
            ...
            return AnimatedSwitcher(
              ...
              child: RichText(
                  ...
                  text: TextSpan(
                      ...
                      children: [
                        TextSpan(
                            text: DAY_NAMES[selectedDay.weekday - 1]
                                .substring(0, 3),
